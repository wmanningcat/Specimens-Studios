    ...
    <table style="width:100%; border-collapse: collapse; margin-top: 1rem;">
      <thead>
        <tr style="background-color: #dbeafe;">
          <th style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">Service</th>
          <th style="border: 1px solid #ccc; padding: 0.5rem; text-align: left;">Rate</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">Basic Cleanup (background removal, color correction)</td>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">$4/image</td>
        </tr>
        <tr>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">Full Figure Plate Assembly</td>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">$15/plate</td>
        </tr>
        <tr>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">Scientific Formatting (TIFFs, scale bars, resolution specs)</td>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">Included</td>
        </tr>
        <tr>
          <td style="border: 1px solid #ccc; padding: 0.5rem;">Rush Delivery (under 48 hrs)</td>
